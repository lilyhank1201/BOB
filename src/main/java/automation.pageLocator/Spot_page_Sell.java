...
//Check orderbook trước khi buy
        OrderBookSell before = new OrderBookSell(driver);
        double beforePrice = OrderBookSell.getAmountInOrderbookPrice(price);
...
//            System.out.println("check priceExists "+ priceExists);
////            boolean priceExists = orderbook.checkPriceExists(price);
//            Thread.sleep(2000);
//            if (!priceExists) {
//                System.out.println(priceToFind + " có trên order book");
//                Thread.sleep(2000);
//                WebElement amountElement = driver.findElement(By.xpath("//div[@class='table__box-item flex-end']//div[@class='item__number red signle-orderbook']/p[2]"));
//                System.out.println("check element " + driver.findElement(By.xpath("//div[@class='table__box-item flex-end']//div[@class='item__number red signle-orderbook']/p[1]")).getText());
//                Thread.sleep(2000);
//                System.out.println("check amount " + amountElement);
//                System.out.println("check text " + amountElement.getText());
